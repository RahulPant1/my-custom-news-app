...
<body>
    ...
    def _render_article_actions(self, article: Dict[str, Any], template_data: Dict[str, Any]) -> str:
        # Feedback buttons removed to give more space for news content
        return ""
    ...
    def render_mobile_card_template(self, digest_data: Dict, user_id: str = None, delivery_id: int = None, 
        ...
        <body>
            <div class="email-container">
                <div class="header">
                    <h1>📰 News Digest</h1>
                    <p>{current_date} • {total_articles} articles</p>
                </div>
                ...
                <div class="footer">
                    <div class="feedback-section">
                        <a href="{base_url}/feedback?user_id={user_id}&type=excellent&delivery_id={delivery_id}" class="feedback-btn">⭐</a>
                        <a href="{base_url}/feedback?user_id={user_id}&type=good&delivery_id={delivery_id}" class="feedback-btn">👍</a>
                        <a href="{base_url}/feedback?user_id={user_id}&type=needs_improvement&delivery_id={delivery_id}" class="feedback-btn">📝</a>
                    </div>
